...
import org.example.chatapp_p2p.Model.file;
...
//        getClass().getResource("/org/example/chatapp_p2p//org/example/chatapp_p2p/Ressources/Logo.png",50,50,true,false).toExternalForm()
    ...
    {
        Vector<org.example.chatapp_p2p.Model.file> files = new Vector<>();
        try
        {
            pw.println(11);

            files = (Vector<org.example.chatapp_p2p.Model.file>) ois.readObject();
...
//        textFielMessage.setEditable(false);
    ...
    public class Cell extends ListCell<String>
    {
        ...
        public Cell()
        {
            ...
            pane1 = new Pane() ;
            profile= new Image((getClass().getResource("/org/example/chatapp_p2p/Ressources/userdark.png").toExternalForm())) ;
...
//        clipRequestNotif.play();
    ...
    public void addNodeFxMethodLeft(String ms)
    {
        Platform.runLater(() ->
        {
            ...
            ImageView imageView = new ImageView((getClass().getResource("/org/example/chatapp_p2p/Ressources/userwhit.png").toExternalForm())) ;
    ...
    public void addNodeFxMethodRight(String ms)
    {
        Platform.runLater(() ->
        {
            ...
            ImageView imageView = new ImageView((getClass().getResource("/org/example/chatapp_p2p/Ressources/userdark.png").toExternalForm())) ;
            imageView.setFitWidth(30);
            imageView.setFitHeight(30);
...
//                    clipMessageNotif.play();
    ...
    void VedioCall(ActionEvent event) throws IOException
    {
        ...
        Pane pane =  new Pane() ;
        ImageView imageView = new ImageView((getClass().getResource("/org/example/chatapp_p2p/Ressources/tabletmocup.png").toExternalForm())) ;
    ...
    void AudioCall(ActionEvent event) throws IOException
    {
        ...
        Stage primaryStage = new Stage() ;
        Pane pane =  new Pane() ;
        ImageView imageView = new ImageView((getClass().getResource("/org/example/chatapp_p2p/Ressources/phonemocup.png").toExternalForm())) ;
        imageView.setFitWidth(300);
        imageView.setFitHeight(550);

        ImageView voice = new ImageView((getClass().getResource("/org/example/chatapp_p2p/Ressources/voicerecored.png").toExternalForm()));
        voice.setFitWidth(250);
        voice.setFitHeight(80);
        voice.setX(25);
        voice.setY(200);

        ImageView micro = new ImageView(getClass().getResource("/org/example/chatapp_p2p/Ressources/microphone.png").toExternalForm()) ;
        micro.setX(70);
        micro.setY(70);
    ...
    public  class AudioCall  implements Runnable
    {
        ...
        public void createFrame()
        {
            Platform.runLater(()->
            {
                ...
                Stage primaryStage = new Stage() ;
                Pane pane =  new Pane() ;
                ImageView imageView = new ImageView(new Image((getClass().getResource("/org/example/chatapp_p2p/Ressources/phonemocup.png").toExternalForm()))) ;
                imageView.setFitWidth(300);
                imageView.setFitHeight(550);

                ImageView voice = new ImageView(new Image((getClass().getResource("/org/example/chatapp_p2p/Ressources/voicerecored.png").toExternalForm()))) ;
                voice.setFitWidth(250);
                voice.setFitHeight(80);
                voice.setX(25);
                voice.setY(200);
